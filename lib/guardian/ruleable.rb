module Guardian
  ...
  module Ruleable
     module ClassMethods
        ...
        def super_rule
          self.new(role_id: -1, behavior: true, action_name: :manage, resourceable_type: :all, module_name: :all)
        end
    ...
    def matches_action? action
      action_name == :manage || action_name == action
    end

    def matches_resource? resource
      resourceable_type == 'all' || self.resourceable == resource || matches_resource_class?
    end
